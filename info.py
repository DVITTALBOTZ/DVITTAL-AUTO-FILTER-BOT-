...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '1003135165536').split()]  # For Multiple Id Use One Space Between Each.
...
reqst_channel = environ.get('REQST_CHANNEL', '1003131238868')
...
DATABASE_NAME = environ.get('DATABASE_NAME', "levinobot")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'levinocollection')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/mvstore00')
...
OWNER_LNK = environ.get('OWNER_LNK', 'let_owner')
